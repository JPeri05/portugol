programa
{
	...
	funcao inicio()
	{
		...
		faca {	
				...
				escreva (" 1 - Candidato(a) ", Candidato1,"\n")
				escreva (" 2 - Candidato(a) ", Candidato2,"\n")
				escreva (" 3 - Candidato(a) ", Candidato3,"\n")
			...
			escolha (voto)
			{
				...
				caso 1:
				escreva (" Você votou no(a) candidato(a) ", Candidato1,"\n")
				candidato1 ++
				pare
		
				caso 2:
				escreva (" Você votou no(a) candidato(a) ", Candidato2,"\n")
				candidato2 ++
				pare
		
				caso 3:
				escreva ( "Você votou no(a) candidato(a) ", Candidato3,"\n")
				candidato3 ++
				pare
				...
				escreva ("Total de votos do(a) candidato(a) ", Candidato1," :", candidato1,"\n")
				escreva ("Total de votos do(a) candidato(a) ", Candidato2," :", candidato2,"\n")
				escreva ("Total de votos do(a) candidato(a) ", Candidato3," :", candidato3,"\n")
				...
				se (candidato1 > candidato2 e candidato1 > candidato3) {
					...
					escreva ("O(A) candidato(a) ",Candidato3,"\n")
				} senao {
